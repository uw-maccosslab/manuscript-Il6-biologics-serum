...
-   250125_meta.csv: table containing metadata for each sample analyzed. Paired samples collected from the same patient are indicated by Patient number. Acronyms are defines as: - "SB" - Siltuximab pre-treatment - "ST" - Siltuximab post-treatment - "TB" - Tocilizumab pre-treatment - "TT" - Tociilizumab post-treatment
...
-   fgsea_R_reactome.xlsx: file containing fsgea results, ranked by Pearson R to mAb quantitation; Figure 4C
-   fgsea_R_compartment.csv: dataframe containing Jensesn's compartment fgsea results; figure S1
